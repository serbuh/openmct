 ...
 * at runtime from the About dialog for additional information.
 *****************************************************************************/
export class TelemetryEvaluator {
  constructor(telemetryAPI, timeAPI, domainObject, samples, averageDatumCallback) {
  ...
  createAverageDatum(telemetryDatum) {
    ...
    const averageValue = this.calculateExpression();
